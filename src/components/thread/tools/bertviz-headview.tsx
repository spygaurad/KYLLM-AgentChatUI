...
interface BertVizHeadViewToolProps {
...
export const BertVizHeadViewTool: React.FC<BertVizHeadViewToolProps> = ({
    stream,
    ...
    const handleControlSubmit = () => {
        ...
        if (!selectedModel  || !controlText.trim()) {
    ...
    return (
        <div className="flex flex-col gap-4 flex-1 p-4 border rounded-md shadow-sm">
            ...
            <Button
                ...
                disabled={parentIsLoading || !controlText.trim() || !selectedModel}
                className="mt-auto"
            >
                {parentIsLoading ? (
                    <>
